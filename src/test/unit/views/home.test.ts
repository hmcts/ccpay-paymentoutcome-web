...
const PAGE_URL = '/payment/234dw23ds34/confirmation/0e5278ca80791bd38c0a9674d087a4a1ba14810ab913f1ffdbe34630d459daa2';
...
describe('Home page success flow', () => {
  ...
  it('should display error body text',  () => {
    ...
    expect(header[0].innerHTML).contains('Your payment reference is<br><strong>RC-1763-0558-0473-0637</strong>');
  });
});
});
